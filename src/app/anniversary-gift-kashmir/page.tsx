...
export const metadata: Metadata = {
  ...
  description: "Luxury anniversary gifts from Kashmir. Celebrate your special day with premium GI-Tagged saffron, Mamra almonds, and curated dry fruit sets.",
  alternates: { canonical: "https://www.kashmiressence.com/anniversary-gift-kashmir" },
};

const WA = "https://wa.me/917019838992?text=Hi%20Kashmir%20Essence%2C%20I%20want%20to%20order%20an%20Anniversary%20gift%20from%20Kashmir.";
    ...
    <main className="bg-ivory-50 min-h-screen pt-24">
      <section className="bg-gradient-to-br from-maroon-950 to-maroon-900 text-white py-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-gold-400 font-black text-xs uppercase tracking-[0.3em] mb-4">❤️ Premium Gifts · Ships to UAE, India & GCC</p>
          <h1 className="text-4xl md:text-5xl font-black mb-5">Anniversary Gifts from Kashmir</h1>
          <p className="text-ivory-300 text-xl mb-10 max-w-2xl mx-auto">Celebrate your anniversary with the most luxurious gifts from Kashmir. GI-Tagged saffron tins, heritage Mamra almond boxes, and curated dry fruit sets.</p>
