...
export const metadata: Metadata = {
  ...
  description: "Unique gifts for friends from Kashmir. Surprise them with premium GI-Tagged saffron, Mamra almonds, and curated dry fruit sets.",
  alternates: { canonical: "https://www.kashmiressence.com/friend-gift-kashmir" },
};

const WA = "https://wa.me/917019838992?text=Hi%20Kashmir%20Essence%2C%20I%20want%20to%20order%20a%20gift%20for%20my%20friend%20from%20Kashmir.";
    ...
    <main className="bg-ivory-50 min-h-screen pt-24">
      <section className="bg-gradient-to-br from-maroon-950 to-maroon-900 text-white py-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-black mb-5">Gifts for Friends from Kashmir</h1>
          <p className="text-ivory-300 text-xl mb-10 max-w-2xl mx-auto">Show your appreciation to your friends with unique gifts from Kashmir. GI-Tagged saffron tins, heritage Mamra almond boxes, and curated dry fruit sets.</p>
